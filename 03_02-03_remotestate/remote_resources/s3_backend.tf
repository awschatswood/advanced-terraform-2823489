...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "red30-tfremotestate-xubao" {
...
resource "aws_s3_bucket_public_access_block" "red30-tfremotestate-xubao" {
  bucket = aws_s3_bucket.red30-tfremotestate-xubao.id
